...
ZoneABC提供了`webn.cc`,`zabc.net`,`sylu.cc`,`sylu.net`,`acg.rest`,`vvvv.ee`和`ctrl.li`后缀的域名.

官网：[https://zoneabc.net/](https://zoneabc.net)

邀请链接：[https://zoneabc.net/register?invite=cd9373abf598410ea2294f47a1db8d6d](https://zoneabc.net/register?invite=cd9373abf598410ea2294f47a1db8d6d)

第一步，点击上面两个链接中的其中一个，进入注册界面，推荐使用邀请链接注册，那样你可以获得额外的10积分.

第二步，注册好账户后，进入面板，注册一个域名.**注意，一些前缀比较短的域名会需要积分，经过测试，前缀长度为7及以上的域名无需积分，如果有错误请指正**
